...
/***/ "./azure/application_insights/AppinsightsQueryEditor.tsx":
/*!***************************************************************!*\
  !*** ./azure/application_insights/AppinsightsQueryEditor.tsx ***!
  \***************************************************************/
/*! exports provided: AppinsightsQueryEditor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AppinsightsQueryEditor", function() { return AppinsightsQueryEditor; });
...
var AppinsightsQueryEditor =
/** @class */
function (_super) {
  Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(AppinsightsQueryEditor, _super);

  function AppinsightsQueryEditor() {
  ...
  AppinsightsQueryEditor.prototype.render = function () {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      ...
      title: "Top"
    }, "Application Insights ID"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("input", {
      ...
      className: "gf-form-label width-12",
      title: "Application Insights Query"
...
/*!***********************************************************!*\
  !*** ./azure/application_insights/ApplicationInsights.ts ***!
  \***********************************************************/
/*! exports provided: AppinsightsQueryEditor, DEFAULT_AI_QUERY, AzureApplicationInsightsQuery, AzureApplicationInsightsDataSource */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DEFAULT_AI_QUERY", function() { return DEFAULT_AI_QUERY; });
...
/* harmony import */ var _AppinsightsQueryEditor__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./AppinsightsQueryEditor */ "./azure/application_insights/AppinsightsQueryEditor.tsx");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AppinsightsQueryEditor", function() { return _AppinsightsQueryEditor__WEBPACK_IMPORTED_MODULE_5__["AppinsightsQueryEditor"]; });
...
/*!*******************************************************!*\
  !*** ./azure/azure_costanalysis/AzureCostAnalysis.ts ***!
  \*******************************************************/
/*! exports provided: DEFAULT_COST_QUERY, ACA_SUPPORTED_FILTER_TYPES, AzureCostQueryDataParam, AzureCostAnalysisQuery, AzureCostAnalysisDataSource, AzureCostAnalysisQueryEditor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DEFAULT_COST_QUERY", function() { return DEFAULT_COST_QUERY; });
...
function (_super) {
  ...
  function AzureCostAnalysisQuery(refId, options, item, templateSrv) {
    ...
    _this.rawquery = item;
    _this.rawquery.alias = templateSrv.replace(_this.rawquery.alias, options.scopedVars);

    if (_this.rawquery.scope === 'ManagementGroup') {
      _this.scope = templateSrv.replace("/providers/Microsoft.Management/managementGroups/" + item.managementGroupId, options.scopedVars);
    }
...
/* harmony import */ var _grafana_ui__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../../grafana_ui */ "./grafana_ui.ts");
...
function (_super) {
  ...
  function AzureCostAnalysisSubscriptionIdQuery() {
    ...
    _this.onACAScopeChange = function (scope) {
      var _a = _this.props,
          query = _a.query,
          onChange = _a.onChange;
      var azCostAnalysis = query.azureCostAnalysis;
    ...
    _this.onACAManagementGroupNameChange = function (event) {
      var MGGroupName = event.target.value;
      var _a = _this.props,
          query = _a.query,
          onChange = _a.onChange;
      var azCostAnalysis = query.azureCostAnalysis;
  ...
  AzureCostAnalysisSubscriptionIdQuery.prototype.render = function () {
    ...
    if (query.azureCostAnalysis.scope === 'Subscription') {
      ScopeId = react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
        className: "gf-form-inline"
      ...
      }, "Management group ID"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("input", {
        className: "gf-form-input width-24",
        type: "text",
    ...
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      ...
      className: "gf-form-label width-12",
      title: "Scope"
    }, "Scope"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Select"], {
      className: "width-24",
      value: Scopes.find(function (gran) {
        return gran.value === query.azureCostAnalysis.scope;
      }),
      options: Scopes,
      defaultValue: query.azureCostAnalysis.scope,
      onChange: this.onACAScopeChange
    })))), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", null, ScopeId));
  };
...
function (_super) {
  ...
  AzureCostAnalysisGroupingQuery.prototype.render = function () {
    ...
    if (query.azureCostAnalysis.grouping[0].type === 'TagKey') {
      GroupingNameField = react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
        className: "gf-form"
      }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
        className: "gf-form gf-form--grow"
      }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("label", {
        className: "gf-form-label width-12",
        title: "Tag Name"
      }, "Tag Name"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("input", {
  ...
  AzureCostAnalysisFilterQuery.prototype.render = function () {
    ...
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", null, query.azureCostAnalysis.filters.length === 0 ? react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      ...
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
        ...
        className: "width-12",
        value: FilterOperators.find(function (op) {
          return op.value === filter.Operator;
        }),
...
var AzureCostAnalysisAliasyQuery =
/** @class */
function (_super) {
  Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(AzureCostAnalysisAliasyQuery, _super);

  function AzureCostAnalysisAliasyQuery() {
    var _this = _super !== null && _super.apply(this, arguments) || this;

    _this.onACAAliasChange = function (event) {
      var _a = _this.props,
          query = _a.query,
          onChange = _a.onChange;
      var azCostAnalysis = query.azureCostAnalysis;
  ...
  AzureCostAnalysisAliasyQuery.prototype.render = function () {
    var query = this.props.query;
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      className: "gf-form-inline"
    }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      ...
      className: "gf-form-label width-12",
      title: "Leave blank for default. Or refer as {{default}} for default value"
    }, "Alias"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("input", {
      className: "gf-form-input width-24",
      value: query.azureCostAnalysis.alias,
      onChange: this.onACAAliasChange,
      type: "text"
    }))));
  };

  return AzureCostAnalysisAliasyQuery;
}(react__WEBPACK_IMPORTED_MODULE_2__["PureComponent"]);
...
function (_super) {
  ...
  AzureCostAnalysisQueryEditor.prototype.render = function () {
    ...
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(AzureCostAnalysisSubscriptionIdQuery, {
      ...
      query: query,
      onChange: onChange
    }), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(AzureCostAnalysisAliasyQuery, {
      query: query,
      onChange: onChange
    }));
  };
...
function () {
  function AzureCostAnalysisResultItem(row, columns, query) {
    ...
    if (query.rawquery.alias && query.rawquery.alias !== "{{default}}" && (query.rawquery.alias.indexOf('{{default}}') > -1 || this.label === 'cost')) {
...
/***/ "./azure/azure_service_health/ServiceHealth.ts":
/*!*****************************************************!*\
  !*** ./azure/azure_service_health/ServiceHealth.ts ***!
  \*****************************************************/
/*! exports provided: AzureServiceHealthQueryEditor, DEFAULT_SERVICE_HEALTH_QUERY, AzureServiceHealthQuery, AzureServiceHealthDataSource */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DEFAULT_SERVICE_HEALTH_QUERY", function() { return DEFAULT_SERVICE_HEALTH_QUERY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AzureServiceHealthQuery", function() { return AzureServiceHealthQuery; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AzureServiceHealthDataSource", function() { return AzureServiceHealthDataSource; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
/* harmony import */ var _AzureMonitorPluginQuery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../AzureMonitorPluginQuery */ "./azure/AzureMonitorPluginQuery.ts");
/* harmony import */ var _app_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../../app/utils */ "./app/utils.ts");
/* harmony import */ var _ServiceHealthResultsParser__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ServiceHealthResultsParser */ "./azure/azure_service_health/ServiceHealthResultsParser.ts");
/* harmony import */ var _ServiceHealthEditor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ServiceHealthEditor */ "./azure/azure_service_health/ServiceHealthEditor.tsx");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AzureServiceHealthQueryEditor", function() { return _ServiceHealthEditor__WEBPACK_IMPORTED_MODULE_4__["AzureServiceHealthQueryEditor"]; });
...
var DEFAULT_SERVICE_HEALTH_QUERY = {
  subscriptionId: ''
};

var AzureServiceHealthQuery =
/** @class */
function (_super) {
  Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(AzureServiceHealthQuery, _super);

  function AzureServiceHealthQuery(refId, subscriptionId, from, to) {
    if (refId === void 0) {
      refId = '';
    }
    ...
    var _this = _super.call(this, refId, '') || this;

    _this.subscriptionId = subscriptionId;
    var startTime = from.toISOString();
    var endTime = to.toISOString();
    _this.filter = "eventTimestamp ge '" + startTime + "' and eventTimestamp le '" + endTime + "' and categories eq 'ServiceHealth'";
    return _this;
  }

  return AzureServiceHealthQuery;
}(_AzureMonitorPluginQuery__WEBPACK_IMPORTED_MODULE_1__["AzureMonitorPluginQuery"]);



var AzureServiceHealthDataSource =
/** @class */
function () {
  AzureServiceHealthDataSource.$inject = ["azureConnection", "templateSrv"];

  /** @ngInject */
  function AzureServiceHealthDataSource(azureConnection, templateSrv) {
    this.azureConnection = azureConnection;
    this.templateSrv = templateSrv;
    this.url = this.azureConnection.instanceSettings.url;
    this.baseUrl = "/" + this.azureConnection.instanceSettings.jsonData.cloudName;
  ...
  AzureServiceHealthDataSource.prototype.doServiceHealthRequest = function (query, maxRetries) {
    if (maxRetries === void 0) {
      maxRetries = 1;
    }
    ...
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        requestObject = {
          ...
          method: 'GET',
          url: this.url + this.baseUrl + ("/subscriptions/" + query.subscriptionId + "/providers/microsoft.insights/eventtypes/management/values?api-version=2017-03-01-preview&$filter=" + query.filter)
        };
        return [2
        /*return*/
        , Object(_app_utils__WEBPACK_IMPORTED_MODULE_2__["doBackendRequest"])(requestObject, maxRetries)];
      });
    });
  };

  AzureServiceHealthDataSource.prototype.doQueries = function (queries) {
    var _this = this;

    return queries.map(function (query) {
      return _this.doServiceHealthRequest(query).then(function (result) {
        return {
          result: result,
          query: query
        };
  ...
  AzureServiceHealthDataSource.prototype.query = function (options) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      var queries, promises;
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        queries = options.targets.filter(function (item) {
          var sh = item.azureServiceHealth;
          return item.hide !== true && sh && sh.subscriptionId;
        }).map(function (target) {
          var item = target.azureServiceHealth;
          var queryOption = new AzureServiceHealthQuery(target.refId, _this.templateSrv.replace(item.subscriptionId, options.scopedVars), options.range.from, options.range.to);
          return queryOption;
        });
        ...
        /*return*/
        , Promise.all(promises).then(function (results) {
          var responseParser = new _ServiceHealthResultsParser__WEBPACK_IMPORTED_MODULE_3__["ServiceHealthResponseParser"](results);
          return responseParser.output;
        })];
      });
    });
  ...
  AzureServiceHealthDataSource.prototype.metricFindQuery = function (query) {
    return undefined;
  };

  return AzureServiceHealthDataSource;
}();
...
/***/ "./azure/azure_service_health/ServiceHealthEditor.tsx":
/*!************************************************************!*\
  !*** ./azure/azure_service_health/ServiceHealthEditor.tsx ***!
  \************************************************************/
/*! exports provided: AzureServiceHealthQueryEditor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AzureServiceHealthQueryEditor", function() { return AzureServiceHealthQueryEditor; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash */ "lodash");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react */ "react");
...
var AzureServiceHealthSubscriptionIdQuery =
/** @class */
function (_super) {
  Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(AzureServiceHealthSubscriptionIdQuery, _super);

  function AzureServiceHealthSubscriptionIdQuery() {
    var _this = _super !== null && _super.apply(this, arguments) || this;
    ...
    _this.onASCSubscriptionIDChange = function (event) {
      var acaSubscriptionId = event.value;
      var _a = _this.props,
          query = _a.query,
          onChange = _a.onChange;
      var azCostAnalysis = query.azureServiceHealth;
      azCostAnalysis.subscriptionId = acaSubscriptionId;
      onChange(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, query), {
        azureCostAnalysis: azCostAnalysis
      }));
  ...
  AzureServiceHealthSubscriptionIdQuery.prototype.componentWillMount = function () {
    var _this = this;
  ...
  AzureServiceHealthSubscriptionIdQuery.prototype.render = function () {
    var query = this.props.query;
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      className: "gf-form-inline"
    }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
  ...
  return AzureServiceHealthSubscriptionIdQuery;
}(react__WEBPACK_IMPORTED_MODULE_2__["PureComponent"]);

var AzureServiceHealthQueryEditor =
/** @class */
function (_super) {
  Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(AzureServiceHealthQueryEditor, _super);

  function AzureServiceHealthQueryEditor() {
    return _super !== null && _super.apply(this, arguments) || this;
  }

  AzureServiceHealthQueryEditor.prototype.render = function () {
    var _a = this.props,
        query = _a.query,
        onChange = _a.onChange,
        datasource = _a.datasource;
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(AzureServiceHealthSubscriptionIdQuery, {
      query: query,
      onChange: onChange,
      datasource: datasource
    }));
  ...
  return AzureServiceHealthQueryEditor;
}(react__WEBPACK_IMPORTED_MODULE_2__["PureComponent"]);
...
/***/ "./azure/azure_service_health/ServiceHealthResultsParser.ts":
/*!******************************************************************!*\
  !*** ./azure/azure_service_health/ServiceHealthResultsParser.ts ***!
  \******************************************************************/
/*! exports provided: ServiceHealthResponseParser */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ServiceHealthResponseParser", function() { return ServiceHealthResponseParser; });
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash */ "lodash");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__);
...
var ServiceHealthResponseParser =
/** @class */
function () {
  function ServiceHealthResponseParser(response) {
    var _this = this;
    ...
    response.forEach(function (res) {
      if (res && res.result && res.result.data && res.result.data.value) {
        res.result.data.value.forEach(function (rowitem, index) {
          console.log(rowitem);

          if (index === 0) {
            var columns_1 = [];
            Object(lodash__WEBPACK_IMPORTED_MODULE_0__["forEach"])(rowitem, function (v, k) {
              if (k !== 'properties') {
                var thistype = _typeof(k);
            ...
            _this.output.columns = columns_1;
          }

          var row = [];
          Object(lodash__WEBPACK_IMPORTED_MODULE_0__["forEach"])(rowitem, function (v, k, i) {
            var value = '';
            ...
            if (typeof v === 'string' && k.toLowerCase().indexOf('timestamp') > -1) {
              ...
              value = v || '-';
            } else if (_typeof(v) === 'object' && (v.value || v.localizedValue || v.value === '')) {
  ...
  return ServiceHealthResponseParser;
}();
...
/*!*********************************************!*\
  !*** ./azure/log_analytics/LogAnalytics.ts ***!
  \*********************************************/
/*! exports provided: LogAnalyticsQueryEditor, DEFAULT_LA_QUERY, AzureLogAnalyticsQuery, AzureLogAnalyticsDataSource */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DEFAULT_LA_QUERY", function() { return DEFAULT_LA_QUERY; });
...
/* harmony import */ var _utils_KustoResponseParser__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/KustoResponseParser */ "./azure/utils/KustoResponseParser.ts");
/* harmony import */ var _app_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./../../app/utils */ "./app/utils.ts");
/* harmony import */ var _LogAnalyticsQueryEditor__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./LogAnalyticsQueryEditor */ "./azure/log_analytics/LogAnalyticsQueryEditor.tsx");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "LogAnalyticsQueryEditor", function() { return _LogAnalyticsQueryEditor__WEBPACK_IMPORTED_MODULE_5__["LogAnalyticsQueryEditor"]; });
...
/***/ "./azure/log_analytics/LogAnalyticsQueryEditor.tsx":
/*!*********************************************************!*\
  !*** ./azure/log_analytics/LogAnalyticsQueryEditor.tsx ***!
  \*********************************************************/
/*! exports provided: LogAnalyticsQueryEditor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LogAnalyticsQueryEditor", function() { return LogAnalyticsQueryEditor; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
...
var LogAnalyticsQueryEditor =
/** @class */
function (_super) {
  Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(LogAnalyticsQueryEditor, _super);

  function LogAnalyticsQueryEditor() {
    var _this = _super !== null && _super.apply(this, arguments) || this;
  ...
  LogAnalyticsQueryEditor.prototype.render = function () {
    var query = this.props.query;
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      className: "gf-form-inline"
    }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      ...
      className: "gf-form-label width-12",
      title: "Workspace ID"
    }, "Workspace ID"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("input", {
      className: "gf-form-input width-24",
      type: "text",
  ...
  return LogAnalyticsQueryEditor;
}(react__WEBPACK_IMPORTED_MODULE_1__["PureComponent"]);
...
function (_super) {
  ...
  AzureResourceGraphQueryEditor.prototype.render = function () {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      ...
      className: "gf-form-label width-12",
      title: "Top"
    }, "Top"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("input", {
      ...
      className: "gf-form-label width-12",
      title: "Skip"
    }, "Skip"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("input", {
      className: "gf-form-input width-9",
      type: "text",
...
/*!*******************!*\
  !*** ./config.ts ***!
  \*******************/
/*! exports provided: AzureResourceGraph, AzureApplicationInsights, AzureLogAnalytics, AzureCostAnalysis, AzureServiceHealth, supportedServices, CloudNameAzurePublic, CloudNameAzureGov, CloudNameAzureGermany, CloudNameAzureChina, supportedCloudnames */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AzureServiceHealth", function() { return AzureServiceHealth; });
...
var AzureServiceHealth = "Azure Service Health";
var supportedServices = [{
  ...
  value: AzureServiceHealth,
  label: AzureServiceHealth
}, {
...
/* harmony import */ var _azure_azure_service_health_ServiceHealth__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./azure/azure_service_health/ServiceHealth */ "./azure/azure_service_health/ServiceHealth.ts");
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./config */ "./config.ts");
...
function (_super) {
  ...
  function Datasource(instanceSettings, templateSrv) {
    ...
    _this.azureServiceHealthDatasource = new _azure_azure_service_health_ServiceHealth__WEBPACK_IMPORTED_MODULE_8__["AzureServiceHealthDataSource"](azureConnection, _this.templateSrv);
    return _this;
  }
  ...
  Datasource.prototype.query = function (options) {
    ...
    azureResourceGraphOptions.targets = Object(lodash__WEBPACK_IMPORTED_MODULE_1__["filter"])(azureResourceGraphOptions.targets, ['queryType', _config__WEBPACK_IMPORTED_MODULE_9__["AzureResourceGraph"]]);
    ...
    var azureServiceHealthOptions = Object(lodash__WEBPACK_IMPORTED_MODULE_1__["cloneDeep"])(options);
    azureServiceHealthOptions.targets = Object(lodash__WEBPACK_IMPORTED_MODULE_1__["filter"])(azureServiceHealthOptions.targets, ['queryType', _config__WEBPACK_IMPORTED_MODULE_9__["AzureServiceHealth"]]);

    if (azureServiceHealthOptions.targets.length > 0) {
      var argPromise = this.azureServiceHealthDatasource.query(azureServiceHealthOptions);
    ...
    azureAppInsightsOptions.targets = Object(lodash__WEBPACK_IMPORTED_MODULE_1__["filter"])(azureAppInsightsOptions.targets, ['queryType', _config__WEBPACK_IMPORTED_MODULE_9__["AzureApplicationInsights"]]);
    ...
    azureLogAnalyticsOptions.targets = Object(lodash__WEBPACK_IMPORTED_MODULE_1__["filter"])(azureLogAnalyticsOptions.targets, ['queryType', _config__WEBPACK_IMPORTED_MODULE_9__["AzureLogAnalytics"]]);
    ...
    azureCostAnalysisOptions.targets = Object(lodash__WEBPACK_IMPORTED_MODULE_1__["filter"])(azureCostAnalysisOptions.targets, ['queryType', _config__WEBPACK_IMPORTED_MODULE_9__["AzureCostAnalysis"]]);
...
/* harmony import */ var _azure_application_insights_ApplicationInsights__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./../azure/application_insights/ApplicationInsights */ "./azure/application_insights/ApplicationInsights.ts");
/* harmony import */ var _azure_log_analytics_LogAnalytics__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./../azure/log_analytics/LogAnalytics */ "./azure/log_analytics/LogAnalytics.ts");
/* harmony import */ var _azure_azure_service_health_ServiceHealth__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./../azure/azure_service_health/ServiceHealth */ "./azure/azure_service_health/ServiceHealth.ts");
...
function (_super) {
  ...
  AzureMonitorQueryEditor.prototype.render = function () {
    var query = Object(lodash__WEBPACK_IMPORTED_MODULE_1__["defaults"])(this.props.query, {
      ...
      azureAppInsights: Object(lodash__WEBPACK_IMPORTED_MODULE_1__["defaults"])(this.props.query.azureAppInsights, _azure_application_insights_ApplicationInsights__WEBPACK_IMPORTED_MODULE_7__["DEFAULT_AI_QUERY"]),
      azureLogAnalytics: Object(lodash__WEBPACK_IMPORTED_MODULE_1__["defaults"])(this.props.query.azureAppInsights, _azure_log_analytics_LogAnalytics__WEBPACK_IMPORTED_MODULE_8__["DEFAULT_LA_QUERY"]),
      azureCostAnalysis: Object(lodash__WEBPACK_IMPORTED_MODULE_1__["defaults"])(this.props.query.azureCostAnalysis, _azure_azure_costanalysis_AzureCostAnalysis__WEBPACK_IMPORTED_MODULE_6__["DEFAULT_COST_QUERY"]),
      azureServiceHealth: Object(lodash__WEBPACK_IMPORTED_MODULE_1__["defaults"])(this.props.query.azureServiceHealth, _azure_azure_service_health_ServiceHealth__WEBPACK_IMPORTED_MODULE_9__["DEFAULT_SERVICE_HEALTH_QUERY"])
    });
    var QueryEditor;

    switch (query.queryType) {
      case _config__WEBPACK_IMPORTED_MODULE_4__["AzureResourceGraph"]:
      ...
      case _config__WEBPACK_IMPORTED_MODULE_4__["AzureApplicationInsights"]:
        QueryEditor = react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_azure_application_insights_ApplicationInsights__WEBPACK_IMPORTED_MODULE_7__["AppinsightsQueryEditor"], {
          onChange: this.props.onChange,
          query: query,
          datasource: this.props.datasource
        });
      ...
      case _config__WEBPACK_IMPORTED_MODULE_4__["AzureLogAnalytics"]:
        QueryEditor = react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_azure_log_analytics_LogAnalytics__WEBPACK_IMPORTED_MODULE_8__["LogAnalyticsQueryEditor"], {
          onChange: this.props.onChange,
          query: query,
          datasource: this.props.datasource
        });
      ...
      case _config__WEBPACK_IMPORTED_MODULE_4__["AzureCostAnalysis"]:
      ...
      case _config__WEBPACK_IMPORTED_MODULE_4__["AzureServiceHealth"]:
        QueryEditor = react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_azure_azure_service_health_ServiceHealth__WEBPACK_IMPORTED_MODULE_9__["AzureServiceHealthQueryEditor"], {
          onChange: this.props.onChange,
          query: query,
          datasource: this.props.datasource
        });
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _grafana_ui__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../grafana_ui */ "./grafana_ui.ts");
...
function (_super) {
  ...
  AzureMonitorConfigEditor.prototype.render = function () {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      ...
      title: "Choose an Azure cloud Type"
      ...
      className: "gf-form-label width-10",
      title: "Tenant ID"
    }, "Tenant ID"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("input", {
      className: "gf-form-input width-24",
      type: "text",
      ...
      className: "gf-form-label width-10",
      title: "Client ID"
    }, "Client ID"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("input", {
      className: "gf-form-input width-24",
      type: "text",
      ...
      className: "gf-form-label width-10",
      title: "API Key"
    }, "API Key"), secureJsonFields && secureJsonFields.clientSecret ? react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("label", {
...
/* harmony import */ var _editors_configEditor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./editors/configEditor */ "./editors/configEditor.tsx");
/* harmony import */ var _editors_QueryEditor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editors/QueryEditor */ "./editors/QueryEditor.tsx");




var plugin = new _grafana_data__WEBPACK_IMPORTED_MODULE_0__["DataSourcePlugin"](_datasource__WEBPACK_IMPORTED_MODULE_1__["Datasource"]).setConfigEditor(_editors_configEditor__WEBPACK_IMPORTED_MODULE_2__["AzureMonitorConfigEditor"]).setQueryEditor(_editors_QueryEditor__WEBPACK_IMPORTED_MODULE_3__["AzureMonitorQueryEditor"]);
